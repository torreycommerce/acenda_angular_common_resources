...
(function () {
  ...
  .factory('ValidationMessagesHelper', ['$compile', function ($compile) {
    ...
    var defaultErrorKeys = ['required', 'email', 'url', 'minlength', 'maxlength', 'pattern', 'min', 'max', 'passmatch'];
    ...
    return {
      ...
      getRenderParameters: function (elem) {
        var params = {};
        ['minlength', 'maxlength', 'min', 'max', 'pattern', 'passmatch'].forEach(function (attr) {
                  ...
                  switch (opts.hideTrigger) {
                    case 'valid':
                      ...
                      case 'keydown':
                        ...
                        //each time the error changes, update message
                        scope.$watch(function () {
